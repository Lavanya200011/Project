  ...
  <main class="flex-grow flex items-center justify-center p-6">
    <div class="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
      ...
      <form method="POST" action="check_attendance.php" class="space-y-4">
        ...
        <div>
          <label class="block text-gray-700 font-semibold mb-1">Month (1-12)</label>
          <input type="number" name="month" min="1" max="12" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
        </div>

        <div>
          <label class="block text-gray-700 font-semibold mb-1">Year (e.g., 2025)</label>
