...
<body style="background-color:rgba(0,109,255,0.6);" class="bg-sky-600 text-white">
  <!-- Navbar -->
  <nav style="background-color:rgba(0,109,255,0.6);"class=" text-black px-4 py-4">
    <div class="max-w-7xl mx-auto flex justify-between items-center px-4">
      <div class="flex items-center space-x-4 mx-auto">
        ...
        <span class="font-bold text-lg">KCEM</span>
          ...
          <span><b><i>Karanjekar Collage of engineering & managment sakoli</i></b></span>
    ...
    <div id="mobile-menu" class="md:hidden hidden mt-4 px-4 space-y-2">
      <a href="#" class="block hover:text-blue-600 animate-fade-in-up delay-0 opacity-0">Home Page</a>
      <a href="#" class="block hover:text-blue-600 animate-fade-in-up delay-150 opacity-0">College Website</a>
      <a href="feedback.php" class="block hover:text-blue-600 animate-fade-in-up delay-300 opacity-0">Feedback</a>
      <a href="createclass.php" class="block hover:text-blue-600 animate-fade-in-up delay-450 opacity-0">Create New Class</a>
      <?php if (!$isLoggedIn): ?>
        <a href="login.html" class="block bg-black text-white px-4 py-2 mt-2 rounded animate-fade-in-up">Sign Up/Login</a>
      <?php else: ?>
        <a href="logout.php" class="block bg-red-600 text-white px-4 py-2 mt-2 rounded animate-fade-in-up">Logout</a>
      <?php endif; ?>
    </div>
  </nav>


<div class="flex flex-col lg:flex-row relative bg-gray-600">
  ...
  <aside style="background-color:rgba(0,109,255,0.6);" id="sidebar-menu" class="w-full lg:w-1/3 p-6 text-center  hidden md:block bg-gray-800">
    <nav class="animate-fade-in-up">
      <h3 class="text-sm uppercase font-semibold text-white mb-4">Menu</h3>
      <ul class="space-y-4">
        <li><a href="feedback.php" class="block text-sm font-semibold text-[#99a0b0] hover:text-white p-6 rounded-lg transition transform hover:-translate-y-1 shadow-lg shadow-blue-500/50">Feedback</a></li>
        ...
        <li><a href="createclass.php" class="block text-sm font-semibold text-[#99a0b0] hover:text-white p-6 rounded-lg transition transform hover:-translate-y-1 shadow-lg shadow-blue-500/50">Create New Class</a></li>
        <li>
          <?php if (!$isLoggedIn): ?>
...
<div class="flex relative pb-10 sm:items-center md:w-2/3 mx-auto">
  ...
  <!-- Footer -->
  <footer style="background-color:rgba(89,109,255,0.6)"class="bg-white text-black py-10 px-4">
