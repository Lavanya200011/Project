...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  <header class="bg-white shadow p-4 flex justify-between items-center">
    ...
    echo "<center><h2 class='text-2xl font-bold mt-6'>Attendance Details for $student_name (ID: $student_id)</h2>";
    echo "<h3 class='text-lg text-gray-700'>Month: $month, Year: $year</h3></center>";
